...
export const metadata = {
    ...
    description: "Aprende a usar el router state en Angular para navegar entre páginas y mantener el estado de la aplicación.",
    date: "2025-07-28",
    category: "Angular",
...
# Angular Router State Ejemplo Práctico
...
![Resultados de la Sección](/assets/angular-router-state-ejemplo-practico.gif)
