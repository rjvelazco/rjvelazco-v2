...
export const metadata = {
  ...
  date: "2025-12-11",
  description:
    "Guía práctica de Signal Store (NgRx) para Angular Signals: state atómico, computed pequeños y cuándo mantener el estado en el componente.",
  category: "NgRx",
...
export default function Layout({ children }) {
  return <MdxLayout metadata={metadata} image={"/assets/ngrx-signal-store.png"}>{children}</MdxLayout>;
}

# **Tabla de contenido**

1. [**Introducción**](#introduccion)
2. [**Mantén el state atómico**](#mantener-el-state-atomico)
    - [Cómo simplificar el state con computed signals](#como-simplificar-el-state-con-computed-signals)
